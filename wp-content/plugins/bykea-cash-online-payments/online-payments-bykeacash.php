		...
		if($reqHeaders['Authorization']=='Bearer '.$apiSecretKey){
			if ( $order->has_status('pending') ) {
				if($ipnData['payment_status'] == 'completed'){
					...
					$orderNote = __("Payment against invoice no: <a href='https://invoice.bykea.cash/receive/invoice/".$invoice."' target='_blank'>".$invoice."</a> has been confirmed.");
					...
					$orderNote = __("Payment against invoice no: <a href='https://invoice.bykea.cash/receive/invoice/".$invoice."' target='_blank'>".$invoice."</a> has been declined.");
					$order->add_order_note( $orderNote );
