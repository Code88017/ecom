...
= 3.1 =
* Added invoice status check functionality to check the payment status instantly.
* Added functionality to convert any other currency into PKR based on international rates.
